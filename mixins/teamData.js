      ...
      teamData:[
        {
          ...
          social_links: [
            ...
            { link: 'https://twitter.com/smartholdem', target: '_blank', icon: 'fa-brands fa-twitter', name: 'Twitter' },
          ],
          home_lawyer:true,
          home:true,
          team_p:true,
        },
        {
          ...
          social_links: [
            { link: 'https://github.com/smartholdem', target: '_blank', icon: 'fa-brands fa-github', name: 'GitHub' },
            { link: 'https://twitter.com/smartholdem', target: '_blank', icon: 'fa-brands fa-twitter', name: 'Twitter' },
          ],
          home_lawyer:true,
          home:true,
        ...
        },
        {
          ...
          social_links: [
            { link: 'https://github.com/technologiespro/paper-wallet-generator', target: '_blank', icon: 'fa-brands fa-github', name: 'GitHub' },
            { link: 'https://twitter.com/paperwallettop', target: '_blank', icon: 'fa-brands fa-twitter', name: 'Twitter' },
