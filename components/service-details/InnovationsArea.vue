        ...
        <div v-if="$i18n.locale === 'ru'" class="col-lg-8 order-first order-lg-last">
          ...
          <div class="services__details-text mb-25">
            ...
            <p>
              ...
              один клик мыши. Узнайте больше о доказуемо-честных Web3 играх (ссылка на “про игры”)
            </p>
          </div>
          ...
          <div id="web3-4" class="services__details-text mb-25">
            ...
            <a class="text-primary" target="_blank" href="https://github.com/smartholdem">Пример по разработке простой Web3 игры с TRNG SmartHoldem.</a>
