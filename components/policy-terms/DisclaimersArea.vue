        ...
        <div class="col-xl-10">
          <div class="policy__wrapper policy__translate p-relative z-index-1">
            <div class="policy__item mb-35">
              <h4 class="policy__meta">Effective date: November 20, 2017</h4>
              <p>
              ...
              <p>
                SmartHoldem and its affiliates disclaim all warranties, conditions, common law duties,
                ...
                viruses,
                whether alleged to arise under law, by reason of custom or usage in the trade, or by course of dealing.
              </p>
            </div>

            <div class="policy__item policy__item-2 mb-35">
              <h3 class="policy__title">Without limiting the generality of the foregoing, SmartHoldem and its affiliates make no warranty that</h3>
              <ul>
            ...
            <div class="policy__item policy__item-2 mb-35">
              <h3 class="policy__title">Disclaimer of Warranties</h3>
