          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-9 col-md-11">
              <div class="postbox__details-content-wrapper">
                ...
                <p>Генератор случайных чисел основан на истинно случайной энтропии SmartHoldem. В качестве источника энтропии используется блокчейн SmartHoldem.</p>
                ...
                <div class="postbox__details-content">
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <p><i>Если вы узнаете выигравший номер по завершении игры, вернётесь в прошлое и выберите этот номер, то результат игры изменится и выигрышный номер станет другим.</i></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="postbox__details-content-2 pb-40">
                  ...
                  <ul>
                    ...
                    <li>Операции проводимые в BlockChain SmartHoldem непредсказуемы и могут происходить в любое время
                      (регистрация делегата, отправка транзакций, сумма транзакций, время транзакций, голосование)
                    </li>
                  </ul>
                  <div class="row">
                    <div class="col-xl-12">
